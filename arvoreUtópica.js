...
E assim ...
Escreva a função alturaArvoreUtopica, que utilize uma quantidade de ciclos de crescimento, e retorne a altura resultante
da árvore de Laura.
 */
function alturaArvoreUtopica(ciclosDeCrescimento){
    tamanhoArvore = 1;
    for (var i = 1; i <= ciclosDeCrescimento; i++){
        if (i % 2 == 0){
            tamanhoArvore += 1;
        } else {
